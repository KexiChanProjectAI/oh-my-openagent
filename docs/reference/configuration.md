...
Run `bunx @zenkexi/oh-my-openagent install` for guided setup. Run `opencode models` to list available models.
...
Run `bunx @zenkexi/oh-my-openagent doctor --verbose` to see effective model resolution for your config.
...
- Manual refresh is available via `bunx @zenkexi/oh-my-openagent refresh-model-capabilities`.
